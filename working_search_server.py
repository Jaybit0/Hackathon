...
app = FastAPI(title="Working Search Server", description="A web search server using FastMCP with comprehensive logging")

# Add the MCP logging middleware
app.add_middleware(MCPLoggingMiddleware)

# Add the MCP routes to the FastAPI app
# Use the FastMCP http_app method
...
def read_root():
    return {
        "message": "Working Search Server with MCP Logging is running", 
...
if __name__ == "__main__":
    print("🚀 Starting Working FastMCP server with comprehensive logging...")
    print("=" * 60)
    ...
    print("uvicorn working_search_server:app --host 0.0.0.0 --port 8000 --reload")
    print()
